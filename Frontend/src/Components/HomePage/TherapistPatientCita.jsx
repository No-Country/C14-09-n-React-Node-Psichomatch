...
const loadPatientReservation = async (id) => {
    const response = await axios.get(`http://localhost:3001/reservation/therapist/${params.id}`);
      ...
      <div className="w-full flex items-center justify-center lg:w-1/2">
        <div className="md:mx-6 md:p-12">
          ...
          <div>
            ...
            <p className="">En este espacio encontrarás tú historial de citas con los pacientes que han agendado contigo.</p>
            </div>
            ...
            <h1 className="mb-12 mt-1 pb-1 text-xl font-semibold text-center">
              ...
              {data &&
                data.map((reservation, index) => (
                 ...
                 <h1><span className="font-bold">Fecha: </span>{reservation.Availability.date}</h1> 
                        <h1><span className="font-bold">Paciente: </span>{reservation.Patient.name} {reservation.Patient.lastName}</h1>   
