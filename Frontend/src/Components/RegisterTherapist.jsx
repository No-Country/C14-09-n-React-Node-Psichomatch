...
const RegisterTherapist = () => {
  ...
  const handleSubmit = async(e) =>{
    ...
    console.log(name + lastName + image + price + description + adress + CategoryId + CountryId + phone + linkedIn + email + PlanId + password)
    
    if(name && lastName && image && price && description && adress && CategoryId && CountryId && phone && linkedIn && email && PlanId && password){
            await uploadImage(image)
            await dispatch(insertTherapist({name,lastName,image, price: Number(price), description, adress, CategoryId, CountryId, phone, linkedIn, email, PlanId, password}))
  ...
  return (
    <div className="w-full p-12">
      <form onSubmit={handleSubmit} className="flex flex-col ">
        <h1 className="text-center font-bold text-3xl">Registro de Psicólogo</h1>
...
<path d="M21.7188 106.743H94.1504V23.3818H78.386V16.0281C78.4041 11.7515 74.9604 8.25217 70.6466 8.15775H45.4931C41.1205 8.21615 37.5771 11.6931 37.4683 16.0281V23.3953H21.7178L21.7188 106.743ZM42.6441 16.0275C42.7256 14.5092 43.9491 13.2963 45.4806 13.2199H70.6468C72.133 13.3098 73.2749 14.5542 73.2251 16.0275V23.3947H42.6441V16.0275Z" fill="#A6B3FF"/>
<path d="M101.962 23.4221V106.842C109.756 106.703 116 100.4 116 92.6739V37.6763C116 29.9407 109.765 23.6199 101.962 23.4497V23.4221Z" fill="#A6B3FF"/>
<path d="M13.9065 23.4221C6.10366 23.5703 -0.108603 29.9403 0.00043716 37.6763V92.6739C-0.0630009 100.378 6.14032 106.694 13.9065 106.842V23.4221Z" fill="#A6B3FF"/>
</g>
<defs>
...
<div className="p-6">
              ...
              <ul className="list-disc">
                ...
                <li>
                  Acceso a herramientas de gestion de pacientes y documentacion
                  clinica en linea.
                </li>
                <li>
        ...
        <button className="bg-violet-100 rounded-full w-48 py-2 mx-auto my-10" type="submit">Crear perfil</button>
      </form>
    </div>
  );
};
